# Paired legacy-versus-corrected LEC control
...
This is a correction-only diagnostic. It is deliberately stored under
`paired_control/` and must not be presented as the full article-population
comparison. The latter is generated by `scripts/article_figures/`.
